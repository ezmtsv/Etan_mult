...
public class frag_cur extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.frag_lay_cur, null);
...
//        change_time = (ImageView)v.findViewById(R.id.change_time);
        ...
        if(mobj.frag_select_but>3){
            if(mobj.frag_select_but!= auto_range_ON){ mobj.frag_select_but = 3;}
        }
...
//        v_menu.setOnClickListener(oclB);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.but_rms:
                    ...
                    show_RMS(flag_mod_RMS); mobj.frag_com_exe = frag_com_RMS;
                    break;
                case R.id.but_arif:
                    mobj.frag_select_but_RMS = flag_mod_Average;
                    show_RMS(flag_mod_Average); mobj.frag_com_exe = frag_com_RMS;
                    break;
                case R.id.but_rect:
                    mobj.frag_select_but_RMS = flag_mod_Average_rectified;
                    show_RMS(flag_mod_Average_rectified); mobj.frag_com_exe = frag_com_RMS;
                    break;
                case R.id.but_amp:
                    mobj.frag_select_but_RMS = flag_mod_Amplitude;
                    show_RMS(flag_mod_Amplitude); mobj.frag_com_exe = frag_com_RMS;
                    break;
                case R.id.txt_edit:
    ...
    private void show_range(int range) {
        try {
            but_range0.setImageBitmap(mobj.btm_grey_range_lay2[4][0]);
            but_range1.setImageBitmap(mobj.btm_grey_range_lay2[4][1]);
            but_range2.setImageBitmap(mobj.btm_grey_range_lay2[4][2]);
            but_range3.setImageBitmap(mobj.btm_grey_range_lay2[4][3]);
            but_range_auto.setImageBitmap(mobj.btm_butgrey_autoCUR_range_lay2);

            if (mobj.frag_select_but != auto_range_ON) {
                switch (range) {
                    case null_range:
                        but_range0.setImageBitmap(mobj.btm_green_range_lay2[4][range]);
                        break;
                    case one_range:
                        but_range1.setImageBitmap(mobj.btm_green_range_lay2[4][range]);
                        break;
                    case two_range:
                        but_range2.setImageBitmap(mobj.btm_green_range_lay2[4][range]);
                        break;
                    case three_range:
                        but_range3.setImageBitmap(mobj.btm_green_range_lay2[4][range]);
                        break;
                }
            } else {
                but_range_auto.setImageBitmap(mobj.btm_butgreen_autoCUR_range_lay2);
            }
...
/*
    posX = 495*mobj.scale_X;
    posY = 1080*mobj.scale_Y;
    change_time.setImageBitmap(mobj.btm_but_grey_change);
    set_pos_but(change_time, posX, posY);*/
